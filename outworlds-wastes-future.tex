...
Commanders are encouraged to try to use the typical unit composition of their faction but are not required to do so.
...
Commanders are welcome to pick a single type of unit for their 3,000 BV non-mech forces.
For example, a Commander building a Clan nova may choose to only use 5 mechs and 5 points of Elemental battle armor to keep their list complexity down.\\
...
Battlemech            & Pilot           & Gunnery & Piloting & BV    & Adjusted BV \\
\hline
Carrion Crow A        & Sarah Magnus    & 3       & 4        & 1,622 & 2,141 \\
Nova U                &       Bryn      & 4       & 5        & 1,413 & 1,413 \\
Adder J               &       Ada       & 4       & 5        & 1,222 & 1,222 \\
Kit Fox V             &       Soton     & 3       & 4        &   974 & 1,286 \\
Fire Moth A           &       Tina      & 3       & 4        &   639 &   843 \\
Gnome BA              &                 & 3       & 4        &   580 &   766 \\
Elemental BA, MicroPL &                 & 3       & 4        &   480 &   634 \\
Elemental BA, Laser   &                 & 3       & 4        &   447 &   590 \\
Elemental BA, HMG     &                 & 3       & 4        &   415 &   548 \\
Elemental BA, Flamer  &                 & 3       & 4        &   404 &   533 \\
\hline
Total                 &                 &         &          &       & 9,976 \\
Unspent               &                 &         &          &       &    24 \\
\hline
...
\item {\bf Train}: Pay the difference in BV skill multiplier times 250,000 C-bills to upgrade a unit's skill levels.
...
Therefore, it costs 80,000 C-bills to train a 4/5 pilot to be a 3/4 pilot.
...
New units cannot be upgraded past the skill limits given in the Force Construction section.
...
A secondary objective for all commanders is to cripple or destroy an enemy mech.
The secondary objective can only be awarded once per side.
