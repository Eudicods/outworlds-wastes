...
A Commander can create a custom faction list on the \href{http://www.masterunitlist.info/}{Master Unit List} representing their modified version of the base faction.\\

To create a custom faction list, go to the \href{http://www.masterunitlist.info/Unit/Filter}{Units Tab on Master Unit List}.
Filter the factions to include one faction list and one general list.
...
All other restrictions, such as era and technology level, from the basic Force Construction rules still apply.\\ 
