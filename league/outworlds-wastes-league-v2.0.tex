...
\begin{table}[h!]
\centering
\begin{tabular}{| m{4em} | m{4em} |  m{4em} | m{8em} | m{8em} |}
\hline
...
\cline{2-5}
      & \multirow{6}{*}{4 - 6}
               & 1 & Melee Master      & Marksman          \\
      &        & 2 & Sandblaster       & Maneuvering Ace   \\
      &        & 3 & Range Master      & Multi-Tasker      \\
      &        & 4 & Street Fighter    & Range Master      \\
      &        & 5 & Swordsman         & Street Fighter    \\
      &        & 6 & Zweihander        & Speed Demon       \\
\hline
\multirow{7}{*}{6}
      & 1 - 4
...
\hline
\end{tabular}
\caption{Random Special Pilot Ability Table, 'Mechs and Protmechs}
\end{table}

\begin{table}[h!]
\centering
\begin{tabular}{| m{4em} | m{4em} |  m{4em} | m{8em} | m{8em} | m{8em} |}
\hline
...
\multirow{12}{*}{1 - 5}
      ...
      &        & 6 & Multi-Tasker      & Maneuvering Ace   & Light Horseman    \\
\cline{2-6}
      & \multirow{6}{*}{4 - 6}
               & 1 & Stand Aside       & Marksman          & Marksman          \\
      &        & 2 & Oblique Attacker  & Multi-Tasker      & Multi-Tasker      \\
      &        & 3 & Range Master      & Range Master      & Range Master      \\
      &        & 4 & Sandblaster       & Sandblaster       & Sandblaster       \\
      &        & 5 & Speed Demon       & Shaky Stick       & Speed Demon       \\
      &        & 6 & Terrain Master    & Speed Demon       & Urban Guerrilla   \\
\hline
\multirow{7}{*}{6}
      & 1 - 4
               & * & Human TRO         & Human TRO         & Human TRO         \\
\cline{2-6}
      & \multirow{6}{*}{5 - 6}
               & 1 & Combat Intuition  & Golden Goose      & Combat Intuition  \\
      &        & 2 & Cross Country     & Ride the Wash     & Lucky(2)          \\
