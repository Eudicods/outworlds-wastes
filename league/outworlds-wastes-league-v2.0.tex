...
\item {\bf Quirks}: Commanders may customize their mech with quirks.
...
These quirks should generally match the lore and common quirks for the mech.
See \emph{BattleTech: Battlemech Manual}, page 82, for a list of all quirks.
See \emph{BattleTech: Battlemech Manual}, page 90, for a table of typical quirks for each mech.
