...
\item {\bf Retrain}: Commanders may retrain a pilot/crew under two circumstances - when selling a unit and immediately purchasing a replacement unit of the same type or when exchanging the pilots/crew between two units.
...
For all retraining, the old and new unit must be the same type.
...
\item {\bf Design Quirks}: Commanders may opt into using \emph{Design Quirks} for all their units.
Both players in a scenario must agree to use \emph{Design Quirks} for them to apply.
...
Both players in a scenario must agree to use \emph{Custom Design Quirks} for them to apply.
...
On a result of 10+, assign an SPA to the unit by rolling 4D6 on the charts below.
If the result is invalid for the unit, roll 4D6 again and use the new result.
Commanders may decide to not apply a valid SPA to the unit; however, do not roll again in this case.

\begin{table}[h!]
\centering
\newcolumntype{R}[1]{>{\raggedleft\let\newline\\\arraybackslash\hspace{0pt}}m{#1}}
\begin{tabular}{| R{1.1em} | m{8em} | m{8em} | m{8em} | m{8em} | m{8em} |}
\hline
       & 'Mech            & Protomech         & Combat Vehicle     & Airborne Unit     & Infantry           \\
\hline
 4     & Sharpshooter      & Sharpshooter      & Sharpshooter      & Sharpshooter      & Sharpshooter       \\
 5     & Weapon Specialist & Weapon Specialist & Weapon Specialist & Golden Goose      & Weapon Specialist  \\
 6     & Combat Intuition  & Combat Intuition  & Combat Intuition  & Weapon Specialist & Combat Intuition   \\
 7     & Blood Stalker     & Terrain Master    & Terrain Master    & Combat Intuition  & Blood Stalker      \\
 8     & Dodge             & Blood Stalker     & Blood Stalker     & Blood Stalker     & Range Master       \\
 9     & Fist Fire         & Range Master      & Range Master      & Range Master      & Multi-Tasker       \\
10     & Hot Dog           & Multi-Tasker      & Multi-Tasker      & Multi-Tasker      & Heavy Horse        \\
11     & Range Master      & Marksman          & Marksman          & Marksman          & Marksman           \\
12     & Multi-Tasker      & Dodge             & Cluster Hitter    & Cluster Hitter    & Cluster Hitter     \\
13     & Marksman          & Cluster Hitter    & Forward Observer  & Dust-Off          & Urban Guerrilla    \\
14     & Maneuvering Ace   & Animal Mimicry    & Maneuvering Ace   & Shaky Stick       & Human TRO          \\
15     & Jumping Jack      & Eagle Eyes        & Human TRO         & Human TRO         & Foot Cavalry       \\
16     & Melee Master      & Maneuvering Ace   & Stand Aside       & Stand Aside       & Forward Observer   \\
17     & Sandblaster       & Jumping Jack      & Eagle's Eyes      & Eagle's Eyes      & Eagle's Eyes       \\
18     & Oblique Attacker  & Oblique Attacker  & Oblique Attacker  & Ground-Hugger     & Light Horseman     \\
19     & Street Fighter    & Sandblaster       & Sandblaster       & Sandblaster       & Eagle Eyes         \\
20     & Swordsman         & Speed Demon       & Speed Demon       & Speed Demon       & Sandblaster        \\
21     & Zweihander        & Street Fighter    & Lucky (2)         & Lucky (2)         & Speed Demon        \\
22     & Tactical Genius   & Tactical Genius   & Cross Country     & Tactical Genius   & Lucky (2)          \\
23     & Natural Grace     & Natural Grace     & Tactical Genius   & Sniper            & Tactical Genius    \\
24     & Sniper            & Sniper            & Sniper            & Ride the Wash     & Sniper             \\
\hline
\end{tabular}
\caption{Random Special Pilot Ability Table}
\end{table}
