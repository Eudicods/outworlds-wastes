...
League organizers pick the era for the current league; any era after the fall of the Star League can be used for league play.
...
\item Commanders should select units from their faction for the league era on the \href{http://www.masterunitlist.info/}{Master Unit List}.
...
\item {\bf Repair}: Pay 25\% of the C-bill cost, rounded up, to repair all internal structure damage and critical components for a mech or combat vehicle that has not been \emph{destroyed}.
...
The cost includes a 4/5 pilot who can be trained.
