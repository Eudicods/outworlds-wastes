...
\begin{tabular}{| m{1.25em} m{12em} m{8em} R{4.6em} R{4.6em} R{3.5em} R{3.8em} |}
\hline
...
\item {\bfseries 2v2}: Many scenarios are described as 1v1; however these scenarios can often support 2v2 or similar play.
...
\item {\bfseries Objectives}: Forces earn 7,000,000 C-bills for completing primary objectives and 3,000,000 C-bills for completing secondary objectives.
...
\item \emph{BattleTech: Tactical Operations}
