...
\titleformat{\subsection}[block]
  {\titlerule\addvspace{4pt}\bfseries\centering}
  {\thesection\enspace}{0pt}{\MakeUppercase}[\vspace{2pt}\titlerule]

\titleformat{\subsubsection} [block]{\bfseries}{}{0em}{\MakeUppercase}

\title{
  \fontfamily{Montserrat-TOsF}\selectfont
  \fontsize{50}{60}\fontseries{ub}\selectfont\MakeUppercase{B}\includegraphics[width=0.5in]{../img/Battletech_A.png}\fontsize{50}{60}\fontseries{ub}\selectfont\MakeUppercase{ttleTech}\\
...
\hline
\rowcolor{lightgray}  \bfseries{Bay} & \bfseries{Unit} & \bfseries{Pilot} & \bfseries{Gunnery} & \bfseries{Piloting} & \bfseries{BV} & \bfseries{Adj BV} \\
\hline
\rowcolor{lightgray} \multicolumn{7}{|c|}{Mechs} \\
\hline
...
\hline
\rowcolor{lightgray}\multicolumn{7}{|c|}{Combat Vehicles} \\
\hline
...
3  & Warrior H-7           &                   & 4       & 5         &   295 &   295 \\
\hline
\rowcolor{lightgray}\multicolumn{7}{|c|}{Infantry/Battle Armor} \\
\hline
...
\hline
\rowcolor{lightgray} \bfseries{First} & \bfseries{Second} & \bfseries{Third} & \bfseries{'Mech} & \bfseries{Protomech} \\
\hline
\multirow{12}{*}{1 - 5}
      & \multirow{6}{*}{1 - 3}
...
\hline
\rowcolor{lightgray} \bfseries{First} & \bfseries{Second} & \bfseries{Third} & \bfseries{Combat Vehicle} & \bfseries{Airborne Unit} & \bfseries{Infantry} \\
\hline
\multirow{12}{*}{1 - 5}
      & \multirow{6}{*}{1 - 3}
...
Narrative based scenarios may include special rewards, such as recovering equipment from the 61st Royal Jump Infantry Division so a commander can add advanced jump infantry to their force.
...
\item {\bfseries BattleTech: Destiny}: Scenarios for this format will focus on small scale combat, with each side controlling approximately one or two mechs.
...
Scenarios can be played with higher BV or PV limits, but the C-bills awarded should be adjusted if the limits are significantly different than the typical limits.
...
Objective payments should be proportionally higher if the scenario has a higher BV limit.

\item {\bfseries Base Pay}: If the force did not complete any objectives, then the force earns 2,000 C-bills for every 10 BV for the scenario, with a minimum of 1,000,000 C-bills.
...
\begin{figure}[h!]
  \centering
  \savebox{\savefig}{\includegraphics[width=8.4in]{../img/Outworlds_Wastes_ilClan_Map.png}}
  \rotatebox{90}{%
...
\hline
\rowcolor{lightgray} \bfseries{Bay} & \bfseries{Unit} & \bfseries{Pilot} & \bfseries{Gunnery} & \bfseries{Piloting} & \bfseries{C-bills} & \bfseries{BV} \\
\hline
\rowcolor{lightgray} \multicolumn{7}{|c|}{Mechs (1 per bay)} \\
\hline
1  & & & & & & \\
2  & & & & & & \\
3  & & & & & & \\
...
12 & & & & & & \\
\hline
\rowcolor{lightgray} \multicolumn{7}{|c|}{Combat Vehicles (2 per bay)} \\
\hline
1 & & & & & & \\
1 & & & & & & \\
2 & & & & & & \\
...
5 & & & & & & \\
\hline
\rowcolor{lightgray} \multicolumn{7}{|c|}{Aerospace (2 per bay)} \\
\hline
1 & & & & & & \\
1 & & & & & & \\
2 & & & & & & \\
2 & & & & & & \\
\hline
\rowcolor{lightgray} \multicolumn{7}{|c|}{Protomechs (5 per bay)} \\
\hline
1 & & & & & & \\
1 & & & & & & \\
1 & & & & & & \\
...
2 & & & & & & \\
\hline
\rowcolor{lightgray} \multicolumn{7}{|c|}{Infantry/Battle Armor (5 tons per bay)} \\
\hline
1  & & & & & & \\
2  & & & & & & \\
3  & & & & & & \\
...
\hline
\rowcolor{lightgray} \bfseries{Item} & \bfseries{C-bills} \\
\hline
\rowcolor{lightgray} \multicolumn{2}{|c|}{Starting Balance} \\
\hline
 & \\
\hline
\rowcolor{lightgray} \multicolumn{2}{|c|}{Objectives} \\
\hline
Primary Objective               & \\
Secondary Objective             & \\
Base Pay (if no objectives met) & \\
\hline
\rowcolor{lightgray} \multicolumn{2}{|c|}{Training} \\
\rowcolor{lightgray} \multicolumn{2}{|c|}{Pay 500,000 $\times$ BV skill multiplier difference} \\
\hline
1 & \\
2 & \\
3 & \\
...
... & \\
\hline
\rowcolor{lightgray} \multicolumn{2}{|c|}{Maintenance (Replace, Repair, and Recruit)} \\
\rowcolor{lightgray} \multicolumn{2}{|c|}{Pay 50\% cost if destroyed, 25\% cost to repair internal damage} \\
\rowcolor{lightgray} \multicolumn{2}{|c|}{Pay 50\% cost per troop killed} \\
\hline
1 & \\
2 & \\
3 & \\
...
... & \\
\hline
\rowcolor{lightgray} \multicolumn{2}{|c|}{Refits} \\
\rowcolor{lightgray} \multicolumn{2}{|c|}{Pay cost difference to change variants} \\
\hline
1 & \\
2 & \\
3 & \\
...
... & \\
\hline
\rowcolor{lightgray} \multicolumn{2}{|c|}{Purchases} \\
\rowcolor{lightgray} \multicolumn{2}{|c|}{Pay cost to add to TOE} \\
\hline
1 & \\
2 & \\
3 & \\
... & \\
\hline
\rowcolor{lightgray} \multicolumn{2}{|c|}{Salvage} \\
\rowcolor{lightgray} \multicolumn{2}{|c|}{Pay 50\% cost to add to TOE or sell to earn 25\% cost} \\
\hline
1 & \\
2 & \\
3 & \\
... & \\
\hline
\rowcolor{lightgray} \multicolumn{2}{|c|}{Total} \\
\hline
 & \\
\hline
\end{tabular}
...
\hline
\rowcolor{lightgray} \bfseries{Gunnery} & \multicolumn{8}{c |}{\bfseries{Piloting/Driving/Anti-Mech}}  \\
\hline
  & 1    & 2    & 3    & 4    & 5    & 6    & 7    & 8    \\
\hline
