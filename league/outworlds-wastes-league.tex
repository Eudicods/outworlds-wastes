...
\hline
\rowcolor{lightgray}  \bf{Bay} & \bf{Unit} & \bf{Pilot} & \bf{Gunnery} & \bf{Piloting} & \bf{BV} & \bf{Adj BV} \\
\hline
...
\hline
\rowcolor{lightgray} \bf{First} & \bf{Second} & \bf{Third} & \bf{'Mech} & \bf{Protomech} \\
\hline
\multirow{12}{*}{1 - 5}
      & \multirow{6}{*}{1 - 3}
...
\hline
\rowcolor{lightgray} \bf{First} & \bf{Second} & \bf{Third} & \bf{Combat Vehicle} & \bf{Airborne Unit} & \bf{Infantry} \\
\hline
\multirow{12}{*}{1 - 5}
      & \multirow{6}{*}{1 - 3}
...
\hline
\rowcolor{lightgray} \bf{Bay} & \bf{Unit} & \bf{Pilot} & \bf{Gunnery} & \bf{Piloting} & \bf{C-bills} & \bf{BV} \\
\hline
...
\hline
\rowcolor{lightgray} \bf{Item} & \bf{C-bills} \\
\hline
...
\hline
\rowcolor{lightgray} \bf{Gunnery} & \multicolumn{8}{c |}{\bf{Piloting/Driving/Anti-Mech}}  \\
\hline
  & 1    & 2    & 3    & 4    & 5    & 6    & 7    & 8    \\
\hline
