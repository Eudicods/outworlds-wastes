...
\hline
 1 & -1 modifier to 'Mech ejection PSRs                          \\
   & Vehicle and ProtoMech crews survive on 12+ medical bay roll \\
\hline
 2 & -2 modifier to 'Mech ejection PSRs                          \\
   & Vehicle and ProtoMech crews survive on 9+ medical bay roll  \\
\hline
 3 & -3 modifier to 'Mech ejection PSRs                          \\
   & Vehicle and ProtoMech crews survive on 6+ medical bay roll  \\
\bottomrule
\end{tabular}
\caption*{Dropship Medical Bay Customization Levels}
\end{table}
