...
See \ifthenelse{\equal{\outworldsMode}{mode-web}}{the \hyperref[subsec:force_construction]{Force Construction} rules}{page \pageref{subsec:force_construction}} for restrictions on the single unique or experimental unit in a force.
