...
\begin{description}
  ...
  \item {\bfseries Special Munitions}: \emph{BattleTech: BattleMech Manual} p. 106-108\ifthenelse{\equal{\outworldsMode}{mode-web}}{, }{\\}\emph{BattleTech: Alpha Strike Commander's Edition} p. 143-150
