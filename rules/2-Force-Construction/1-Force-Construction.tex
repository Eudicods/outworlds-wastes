...
Bays can be empty and can changed to a different configuration.
...
\item The BV cost of a unit must include the skill level.
Skill levels should generally be close to the average skill levels for factions and units given on page 40 of \emph{BattleTech: Total Warfare}.
...
One of the goals of \emph{BattleTech: Outworlds Wastes} is to explore different equipment.
