...
Bay space for all non-mechanized infantry units is shared.
...
\item Unless optional rules are used, a force can only include on-map units.
For example, artillery and air support can only be used on-map by default.
