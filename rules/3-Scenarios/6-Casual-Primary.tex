...
Each building is medium with a construction factor of 60 and tall enough to not be masked by surrounding terrain, unless the players agree upon a different configuration.
...
\item {\bfseries Extraction}: The attackers select a hex within 4 rows of the defenders home edge and more than 4 hexes away from the other edges of the map.
