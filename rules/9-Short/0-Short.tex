...
"\emph{Diplomacy}'s a tank, Sarge, not a sports car."
...
\emph{
Let's see how good your really are, Surrat.
}
...
Even waiting for it, it was surprising when it happened.

The \emph{Fenris} reemerged around the rock formation, running at a full sprint.
In mere seconds it chewed up the distance between itself and the ridge where Charles was trying to get \emph{Diplomacy} into a better firing position.

Only thirty meters away, a defile would provide some cover for the tank while it continued to hurl Gauss rounds downrange.

Unfortunately, \emph{Diplomacy} never got the chance to use it.
...
Armor vaporized at the caress of pulse lasers and \emph{Diplomacy} developed an unsettling and all too familiar grinding sound.
...
Only two connected and neither did more than damaged more armor, of which the machine seemed to have an endless supply.
