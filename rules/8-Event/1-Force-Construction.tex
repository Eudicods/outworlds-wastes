...
BattleMechs can carry Battle Armor equipped with magnetic claws, but receive a -1 MP modifier to their Walking MP (p. 227, \emph{TW}).
...
See the \ifthenelse{\equal{\outworldsMode}{mode-pdf-event}}{\emph{Sample Scenario Logistics Tracking} (see p. \pageref{sec:sample_event_roster})}{sample \hyperref[sec:sample_event_roster]{force tracking} sheet}.
