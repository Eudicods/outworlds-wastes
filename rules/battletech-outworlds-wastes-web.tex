...
\begin{center}
  \fontsize{50}{60}\bfseries\selectfont{\MakeUppercase{B}}\includegraphics[width=0.6in,height=0.6in]{img/Battletech-A.png}\fontsize{50}{60}\bfseries\selectfont{\MakeUppercase{ttleTech}}

  \fontsize{35}{42}\bfseries\selectfont\MakeUppercase{Outworlds Wastes}

  \includegraphics[width=5in,height=5in]{img/Outworlds-Alliance.png}
