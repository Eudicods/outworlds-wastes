...
Alternatively, commanders may maintain and improve their force between scenarios with the \ifthenelse{\equal{\outworldsMode}{mode-pdf-event}}{Force Maintaince rules, page \pageref{subsec:event_force_maintenance}}{\hyperref[subsec:event_force_maintenance]{Force Maintenance} rules}.
