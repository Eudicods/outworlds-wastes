...
The skill levels for a unit may be no better than Gunnery 3/Piloting 4 and no worse than Gunnery 5/Piloting 6.
...
Commanders may maintain and improve their force between scenarios with the \ifthenelse{\equal{\outworldsMode}{mode-pdf-event}}{Force Maintenance rules, page \pageref{subsec:event_force_maintenance}}{\hyperref[subsec:event_force_maintenance]{Force Maintenance} rules}.
An improved force cannot exceed 5,000 BV and must follow the other limitations given above.
See the sample \ifthenelse{\equal{\outworldsMode}{mode-pdf-event}}{force tracking sheet on page \pageref{sec:sample_event_roster}}{\hyperref[sec:sample_event_roster]{force tracking} sheet}.
Alternatively, commanders may use a new force for each scenario.
