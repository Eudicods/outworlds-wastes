...
Commanders should keep track of the outcomes of all scenarios and changes to their force, as shown on the sample \ifthenelse{\equal{\outworldsMode}{mode-web}}{\hyperref[sec:sample_roster]{force roster} and \hyperref[sec:sample_logistics]{scenario logistics tracker}}{force roster on page \pageref{sec:sample_roster} and scenario logistics tracker on page \pageref{sec:sample_logistics}}.
