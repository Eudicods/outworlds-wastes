Units may learn an SPA for free after a track.
...
A unit cannot have more SPAs than are allowed for their experience level, as described in the \emph{BattleTech: Mercenaries} box set or \emph{BattleTech: Hinterlands} sourcebook.
